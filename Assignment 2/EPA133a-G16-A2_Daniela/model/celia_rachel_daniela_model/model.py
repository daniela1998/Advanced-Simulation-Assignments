...
class BangladeshModel(Model):
    ...
    def __init__(self, seed=None, x_max=500, y_max=500, x_min=0, y_min=0, probabilities = {}, scenario = 0): #changed
    ...
    def determine_broken_bridges(self):
        ...
        for agent in self.schedule._agents.values(): 
            if isinstance(agent, Bridge): # changed
    ...
    def step(self):
        ...
        """
        self.schedule.step()
        self.collect_data() #modified #every step, collect data
    ...
    def get_biggest_bridge_delay(self):
        if not self.bridge_delays:
            return None,0  # No bridge delays recorded #modified
